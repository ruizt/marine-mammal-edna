...
source('scripts/analysis/stability-selection-18sv9-dens.R')
source('scripts/analysis/stability-selection-18sv4-dens.R')
source('scripts/analysis/stability-selection-16s-dens.R')

# nested validation procedure; requires nested partition files not on GH
source('scripts/analysis/nested-validation-18sv9-dens.R')
source('scripts/analysis/nested-validation-18sv4-dens.R')
source('scripts/analysis/nested-validation-16s-dens.R')

# model fitting to stable sets
source('scripts/analysis/model-fitting-16s-dens.R')
source('scripts/analysis/model-fitting-18sv4-dens.R')
source('scripts/analysis/model-fitting-18sv9-dens.R')
