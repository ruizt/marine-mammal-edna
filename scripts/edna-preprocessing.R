...
#   mutate(obs.weight = (1/n_depth)*(1/n_cruise)) %>%
#   group_by(cruise) %>%
#   summarize(across(starts_with('asv'), ~weighted.mean(.x, obs.weight)))
...
# problem: average proportions don't follow sum constraint
